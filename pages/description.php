<div class="desc-tel">
    <div class="desc-img">
        ...
        <img src="public/img/<?= $product_id ?>/<?= $images[$product_id][0] ?>" alt="samsung-galaxy-s24-ultra-violet" class="img-in-div">
    </div>
    ...
    <div class="desc">
        ...
        <div class="desc-gamme">
            <span class="gamme"><?= $product["category"]; ?></span>
...
<div class="tags">
    <?php
    foreach ($tags as $tag) {
        $product_tag_ids = explode(',', $product["tag_ids"]);
        $hasTag = in_array($tag['id'], $product_tag_ids);

    ?>
        <div class="tag-item">
            <img src="public/gallerie/<?= $tag['avatar']?>" alt="img-pliable" class="img-tags">
            <div class="texte-tags">
                <span class="<?= $hasTag? 'vert' : 'rouge'?>"><?= $hasTag? 'Avec' : 'Sans'?></span>
            </div>
        </div>
